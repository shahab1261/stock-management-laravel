            ...
            <div class="position-relative">
                ...
                <span class="position-absolute top-50 translate-middle-y" style="left: 20px;">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#999"
                        viewBox="0 0 16 16">
                        <path
                            d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398l3.85 3.85a1 1 0 0 0 1.415-1.415l-3.85-3.85zm-5.242.656a5 5 0 1 1 0-10 5 5 0 0 1 0 10z" />
                    </svg>
                </span>
            </div>
        </div>
        ...
        <ul class="sidebar-nav-list list-unstyled" id="sidebar-menu">
            ...
            @permission('management.date-lock.view')
                <li class="menu-item mb-2" data-name="date-lock">
                    <a href="{{ route('admin.management.date-lock.index') }}"
                        class="menu-link d-flex align-items-center rounded p-2 {{ request()->routeIs('admin.management.date-lock.index') ? 'active' : '' }}">
            ...
            <li class="menu-item mb-2" data-name="overview">
                <a href="{{ route('admin.dashboard') }}"
                    class="menu-link d-flex align-items-center rounded p-2 {{ request()->routeIs('admin.dashboard') ? 'active' : '' }}">
                    <div class="menu-icon d-flex align-items-center justify-content-center me-3">
            ...
            @permission('daybook.view')
                <li class="menu-item mb-2" data-name="daybook">
                    <a href="{{ route('admin.daybook.index') }}"
                        class="menu-link d-flex align-items-center rounded p-2 {{ request()->routeIs('admin.daybook.index') ? 'active' : '' }}">
                        <div class="menu-icon d-flex align-items-center justify-content-center me-3">
                ...
                @else
                    @permission('sales.nozzle.view')
                        <li class="menu-item mb-2" data-name="nozzle-sales">
                            <a href="{{ route('sales.nozzle.index') }}"
                                class="menu-link d-flex align-items-center rounded p-2">
                                <div class="menu-icon d-flex align-items-center justify-content-center me-3">
                    ...
                    @permission('sales.lubricant.view')
                        <li class="menu-item mb-2" data-name="lube-sales">
                            <a href="{{ route('sales.lubricant.index') }}"
                                class="menu-link d-flex align-items-center rounded p-2">
                                <div class="menu-icon d-flex align-items-center justify-content-center me-3">
                    ...
                    @if ($softwareType == 2)
                        @permission('sales.credit.view')
                            <li class="menu-item mb-2" data-name="credit-sales">
                                <a href="{{ route('sales.credit.index') }}"
                                    class="menu-link d-flex align-items-center rounded p-2">
                                    <div class="menu-icon d-flex align-items-center justify-content-center me-3">
            ...
            @permission('trial-balance.view')
                <li class="menu-item mb-2" data-name="trial-balance">
                    <a href="{{ route('admin.trial-balance.index') }}"
                        class="menu-link d-flex align-items-center rounded p-2 {{ request()->routeIs('admin.trial-balance.index') ? 'active' : '' }}">
                        <div class="menu-icon d-flex align-items-center justify-content-center me-3">
            ...
            @permission('profit.view')
                <li class="menu-item mb-2" data-name="profit-loss">
                    <a href="{{ route('admin.profit.index') }}"
                        class="menu-link d-flex align-items-center rounded p-2 {{ request()->routeIs('admin.profit.index') ? 'active' : '' }}">
                        <div class="menu-icon d-flex align-items-center justify-content-center me-3">
            ...
            @permission('dips.view')
                <li class="menu-item mb-2" data-name="dips">
                    <a href="{{ route('admin.dips.index') }}"
                        class="menu-link d-flex align-items-center rounded p-2 {{ request()->routeIs('admin.dips.index') ? 'active' : '' }}">
                        <div class="menu-icon d-flex align-items-center justify-content-center me-3">
            ...
            @permission('wet-stock.view')
                <li class="menu-item mb-2" data-name="wet-stock">
                    <a href="{{ route('admin.wet-stock.index') }}"
                        class="menu-link d-flex align-items-center rounded p-2 {{ request()->routeIs('admin.wet-stock.*') ? 'active' : '' }}">
                        <div class="menu-icon d-flex align-items-center justify-content-center me-3">
                ...
                @permission('billing.view')
                    <li class="menu-item mb-2" data-name="billing">
                        <a href="{{ route('admin.billing.index') }}"
                            class="menu-link d-flex align-items-center rounded p-2 {{ request()->routeIs('admin.billing.*') ? 'active' : '' }}">
                            <div class="menu-icon d-flex align-items-center justify-content-center me-3">
            ...
            @permission('payments.cash-receiving.view')
                <li class="menu-item mb-2" data-name="cash-receipts">
                    <a href="{{ route('admin.payments.cash-receiving') }}"
                        class="menu-link d-flex align-items-center rounded p-2">
                        <div class="menu-icon d-flex align-items-center justify-content-center me-3">
            ...
            @permission('payments.cash-payments.view')
                <li class="menu-item mb-2" data-name="cash-payments">
                    <a href="{{ route('admin.payments.cash-payments') }}"
                        class="menu-link d-flex align-items-center rounded p-2">
                        <div class="menu-icon d-flex align-items-center justify-content-center me-3">
            ...
            @if (auth()->user()->hasAnyPermission([
                ...
                <li class="menu-item mb-2" data-name="payments">
                    <a href="javascript:void(0)" class="menu-link d-flex align-items-center rounded p-2"
                        onclick="toggleSubmenu('paymentsSubmenu')">
                        <div class="menu-icon d-flex align-items-center justify-content-center me-3">
                            <i class="bi bi-currency-exchange"></i>
                        </div>
                        <span class="menu-text">Bank Payments</span>
                    </a>
                        ...
                        <ul class="submenu list-unstyled ms-4 mt-2">
                            @permission('payments.bank-receiving.view')
                                <li class="submenu-item mb-2">
                                    <a href="{{ route('admin.payments.bank-receiving') }}"
                                        class="submenu-link d-flex align-items-center rounded p-2">
                            ...
                            @permission('payments.bank-payments.view')
                                <li class="submenu-item mb-2">
                                    <a href="{{ route('admin.payments.bank-payments') }}"
                                        class="submenu-link d-flex align-items-center rounded p-2">
                                        <div class="submenu-icon d-flex align-items-center justify-content-center me-3">
            ...
            @if (auth()->user()->hasAnyPermission([
                ...
                <li class="menu-item mb-2" data-name="ledgers">
                    <a href="javascript:void(0)" class="menu-link d-flex align-items-center rounded p-2"
                        onclick="toggleSubmenu('ledgersSubmenu')">
                        <div class="menu-icon d-flex align-items-center justify-content-center me-3">
                    ...
                    <div class="collapse" id="ledgersSubmenu">
                        <ul class="submenu list-unstyled ms-4 mt-2">
                            @permission('ledger.product.view')
                                <li class="submenu-item mb-2">
                                    <a href="{{ route('admin.ledger.product') }}"
                                        class="submenu-link d-flex align-items-center rounded p-2">
                            ...
                            @permission('ledger.supplier.view')
                                <li class="submenu-item mb-2">
                                    <a href="{{ route('admin.ledger.supplier') }}"
                                        class="submenu-link d-flex align-items-center rounded p-2">
                            ...
                            @permission('ledger.customer.view')
                                <li class="submenu-item mb-2">
                                    <a href="{{ route('admin.ledger.customer') }}"
                                        class="submenu-link d-flex align-items-center rounded p-2">
                            ...
                            @permission('ledger.bank.view')
                                <li class="submenu-item mb-2">
                                    <a href="{{ route('admin.ledger.bank') }}"
                                        class="submenu-link d-flex align-items-center rounded p-2">
                            ...
                            @permission('ledger.cash.view')
                                <li class="submenu-item mb-2">
                                    <a href="{{ route('admin.ledger.cash') }}"
                                        class="submenu-link d-flex align-items-center rounded p-2">
                            ...
                            @permission('ledger.expense.view')
                                <li class="submenu-item mb-2">
                                    <a href="{{ route('admin.ledger.expense') }}"
                                        class="submenu-link d-flex align-items-center rounded p-2">
                            ...
                            @permission('ledger.employee.view')
                                <li class="submenu-item mb-2">
                                    <a href="{{ route('admin.ledger.employee') }}"
                                        class="submenu-link d-flex align-items-center rounded p-2">
                            ...
                            @permission('ledger.income.view')
                                <li class="submenu-item mb-2">
                                    <a href="{{ route('admin.ledger.income') }}"
                                        class="submenu-link d-flex align-items-center rounded p-2">
            ...
            @if (auth()->user()->hasAnyPermission([
                ...
                <li class="menu-item mb-2" data-name="history">
                    <a href="javascript:void(0)" class="menu-link d-flex align-items-center rounded p-2"
                        onclick="toggleSubmenu('historySubmenu')">
                        <div class="menu-icon d-flex align-items-center justify-content-center me-3">
                    ...
                    <div class="collapse" id="historySubmenu">
                        <ul class="submenu list-unstyled ms-4 mt-2">
                            @permission('history.purchases.view')
                                <li class="submenu-item mb-2">
                                    <a href="{{ route('admin.history.purchases') }}"
                                        class="submenu-link d-flex align-items-center rounded p-2">
                            ...
                            @permission('history.sales.view')
                                <li class="submenu-item mb-2">
                                    <a href="{{ route('admin.history.sales') }}"
                                        class="submenu-link d-flex align-items-center rounded p-2">
                            ...
                            @permission('history.credit-sales.view')
                                <li class="submenu-item mb-2">
                                    <a href="{{ route('admin.history.credit-sales') }}"
                                        class="submenu-link d-flex align-items-center rounded p-2">
                            ...
                            @permission('history.bank-receivings.view')
                                <li class="submenu-item mb-2">
                                    <a href="{{ route('admin.history.bank-receivings') }}"
                                        class="submenu-link d-flex align-items-center rounded p-2">
                            ...
                            @permission('history.bank-payments.view')
                                <li class="submenu-item mb-2">
                                    <a href="{{ route('admin.history.bank-payments') }}"
                                        class="submenu-link d-flex align-items-center rounded p-2">
                            ...
                            @permission('history.cash-receipts.view')
                                <li class="submenu-item mb-2">
                                    <a href="{{ route('admin.history.cash-receipts') }}"
                                        class="submenu-link d-flex align-items-center rounded p-2">
                                        <i class="bi bi-receipt-cutoff me-2"></i>
                            ...
                            @permission('history.cash-payments.view')
                                <li class="submenu-item mb-2">
                                    <a href="{{ route('admin.history.cash-payments') }}"
                                        class="submenu-link d-flex align-items-center rounded p-2">
                                        <i class="bi bi-wallet me-2"></i>
                            ...
                            @permission('history.journal-vouchers.view')
                                <li class="submenu-item mb-2">
                                    <a href="{{ route('admin.history.journal-vouchers') }}"
                                        class="submenu-link d-flex align-items-center rounded p-2">
            ...
            @if (auth()->user()->hasAnyPermission([
                        ...
                        'management.customer-vehicles.view',
                ...
                <li class="menu-item mb-2" data-name="security">
                    <a href="javascript:void(0)" class="menu-link d-flex align-items-center rounded p-2"
                        onclick="toggleSubmenu('securitySubmenu')">
                        <div class="menu-icon d-flex align-items-center justify-content-center me-3">
                        ...
                        <ul class="submenu list-unstyled ms-4 mt-2">
                            ...
                            @if ($softwareType == 1)
                                @permission('management.tanklari.view')
                                    <li class="submenu-item mb-2">
                                        <a href="{{ route('admin.tanklari.index') }}"
                                            class="submenu-link d-flex align-items-center rounded p-2">
                            ...
                            @if ($softwareType == 2)
                                @permission('management.customer-vehicles.view')
                                    <li class="submenu-item mb-2">
                                        <a href="{{ route('admin.customer-vehicles.index') }}"
                                            class="submenu-link d-flex align-items-center rounded p-2">
                            ...
                            @permission('management.nozzles.view')
                                <li class="submenu-item mb-2">
                                    <a href="{{ route('admin.nozzles.index') }}"
                                        class="submenu-link d-flex align-items-center rounded p-2">
                                        <i class="bi bi-droplet me-2"></i>
                            ...
                            @permission('management.settings.view')
                                <li class="submenu-item mb-2">
                                    <a href="{{ route('admin.management.settings.index') }}"
                                        class="submenu-link d-flex align-items-center rounded p-2">
                    ...
                    <div class="collapse" id="reportsSubmenu">
                        <ul class="submenu list-unstyled ms-4 mt-2">
                            @permission('reports.account-history.view')
                                <li class="submenu-item mb-2">
                                    <a href="{{ route('admin.reports.account-history') }}"
                                        class="submenu-link d-flex align-items-center rounded p-2">
                            ...
                            @permission('reports.all-stocks.view')
                                <li class="submenu-item mb-2">
                                    <a href="{{ route('admin.reports.all-stocks') }}"
                                        class="submenu-link d-flex align-items-center rounded p-2">
                                        <i class="bi bi-box-seam me-2"></i>
                        ...
                        @endpermission --}}
                            ...
                            @permission('reports.purchase-transport.view')
                                <li class="submenu-item mb-2">
                                    <a href="{{ route('admin.reports.purchase-transport') }}"
                                        class="submenu-link d-flex align-items-center rounded p-2">
                                        <i class="bi bi-truck me-2"></i>
                            ...
                            @permission('reports.sale-transport.view')
                                <li class="submenu-item mb-2">
                                    <a href="{{ route('admin.reports.sale-transport') }}"
                                        class="submenu-link d-flex align-items-center rounded p-2">
            ...
            <li class="menu-item mb-2" data-name="general-search">
                <a href="{{ route('admin.general-search.index') }}"
                    class="menu-link d-flex align-items-center rounded p-2 {{ request()->routeIs('admin.general-search.index') ? 'active' : '' }}">
                    <div class="menu-icon d-flex align-items-center justify-content-center me-3">
            ...
            <li class="menu-item mb-2" data-name="logout">
                <a href="{{ route('admin.logout') }}" class="menu-link d-flex align-items-center rounded p-2"
