...
@section('description', 'Manage your bank payment transactions')
...
<div class="container-fluid py-4">
    ...
    <div class="row mb-4">
        <div class="col-12 text-center">
            <h3 class="mb-0"><i class="bi bi-credit-card text-primary me-2"></i>Bank Payments</h3>
            <p class="text-muted mb-0">Manage your bank payment transactions and entries</p>
        </div>
    </div>
        ...
        <div class="col-md-4 mb-3">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div>
                        <h6 class="text-muted mb-1">Today's Payments</h6>
    ...
    <!-- Bank Payments Table Section -->
    <div class="row">
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white d-flex justify-content-between align-items-center py-3">
                    <h5 class="mb-0"><i class="bi bi-table me-2"></i>Bank Payments</h5>
                    @permission('payments.bank-payments.create')
                    <button type="button" id="addNewPaymentBtn" class="btn btn-primary d-flex align-items-center">
                ...
                <div class="card-body p-0 pt-0">
                    <div class="table-responsive">
                        <table class="table table-hover table-bordered align-middle mb-0" id="bankPaymentsTable" style="width:100%">
                            <thead>
                                <tr>
                                    <th width="50" class="ps-3 text-center">#</th>
                                    <th class="ps-3 text-center">Date</th>
                                    <th class="ps-3 text-center">Account <small class="text-muted">(Debit)</small></th>
                                    <th class="ps-3 text-center">Bank <small class="text-muted">(Credit)</small></th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="fw-medium text-danger">Rs {{ number_format($transaction->amount, 2) }}</td>
                                    <td>{{ $transaction->description }}</td>
                                    <td class="text-center">
                                        @permission('payments.bank-payments.edit')
                                            <a href="{{ route('payments.bank-payments.edit-vendor', $transaction->tid) }}" 
        ...
        <div class="modal-content border-0 shadow">
            <div class="modal-header bg-primary bg-opacity-10 border-0">
                <h5 class="modal-title" id="modalTitle">
                    <i class="bi bi-plus-circle me-2"></i>Add New Bank Payment
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body p-4" id="modalBody">
                <form id="bankPaymentForm" class="row g-3" action="{{ route('admin.payments.bank-payments.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group mb-0">
                            ...
                            <input type="date" class="form-control border-start-0" id="payment_date" name="transaction_date" value="{{ $dateLock }}" disabled required>
                        </div>
                        <div class="invalid-feedback" id="payment_date-error"></div>
                    </div>

                    <div class="col-md-6">
                        <label for="journal_vendor" class="form-label fw-medium">Select Account <small class="text-muted">(Debit)</small> <span class="text-danger">*</span></label>
                        <div class="input-group mb-0">
                            <span class="input-group-text bg-light border-end-0">
                    ...
                    <div class="col-md-6">
                        <label for="select_banks" class="form-label fw-medium">Banks <small class="text-muted">(Credit)</small> <span class="text-danger">*</span></label>
                        <div class="input-group mb-0">
                            <span class="input-group-text bg-light border-end-0">
                        ...
                        <div class="invalid-feedback" id="select_banks-error"></div>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group mb-0">
                            ...
                            <input type="number" step="0.01" class="form-control border-start-0" id="transaction_amount" name="transaction_amount" min="0" required>
                        </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="input-group mb-0">
                            ...
                            <textarea class="form-control border-start-0" id="transaction_description" name="transaction_description" rows="2" placeholder="Enter transaction description" required></textarea>
                        </div>
...
@push('scripts')
<script src="{{ asset('js/bank-payments-ajax.js') }}"></script>
<script>
    $(document).ready(function() {
        $('#bankPaymentsTable').DataTable({
            processing: true,
            responsive: false,
            scrollX: true,
