...
@section('description', 'Manage your cash payment transactions')
...
<div class="container-fluid py-4">
    ...
    <div class="row mb-4">
        <div class="col-12 text-center">
            <h3 class="mb-0"><i class="bi bi-cash-coin text-primary me-2"></i>Cash Payments</h3>
            <p class="text-muted mb-0">Manage your cash payment transactions and entries</p>
        </div>
    </div>
    ...
    <!-- Cash Payments Table Section -->
    <div class="row">
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white d-flex justify-content-between align-items-center py-3">
                    <h5 class="mb-0"><i class="bi bi-table me-2"></i>Cash Payments</h5>
                    @permission('payments.cash-payments.create')
                ...
                <div class="card-body p-0 pt-0">
                    <div class="table-responsive">
                        <table class="table table-hover table-bordered align-middle mb-0" id="cashPaymentsTable" style="width:100%">
                            <thead>
                                <tr>
                                    ...
                                    <th class="ps-3 text-center">Cash <small class="text-muted">(Credit)</small></th>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @permission('payments.cash-payments.edit')
                                            <a href="{{ route('payments.cash-payments.edit-vendor', $transaction->tid) }}" 
        ...
        <div class="modal-content border-0 shadow">
            <div class="modal-header bg-primary bg-opacity-10 border-0">
                <h5 class="modal-title" id="modalTitle">
                    <i class="bi bi-plus-circle me-2"></i>Add New Cash Payment
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body p-4" id="modalBody">
                <form id="cashPaymentForm" class="row g-3" action="{{ route('admin.payments.cash-payments.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group mb-0">
                            ...
                            <input type="text" class="form-control border-start-0" id="transaction_amount" name="transaction_amount" min="0" required>
                        </div>
...
@push('scripts')
<script src="{{ asset('js/cash-payments-ajax.js') }}"></script>
<script>
