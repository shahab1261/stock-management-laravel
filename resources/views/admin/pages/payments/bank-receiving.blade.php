...
@section('description', 'Manage your bank receipt transactions')
...
<div class="container-fluid py-4">
    ...
    <div class="row mb-4">
        <div class="col-12 text-center">
            <h3 class="mb-0"><i class="bi bi-bank text-primary me-2"></i>Bank Receipts</h3>
            <p class="text-muted mb-0">Manage your bank receipt transactions and entries</p>
        </div>
    </div>
    ...
    <!-- Bank Receipts Table Section -->
    <div class="row">
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white d-flex justify-content-between align-items-center py-3">
                    <h5 class="mb-0"><i class="bi bi-table me-2"></i>Bank Receipts</h5>
                    @permission('payments.bank-receiving.create')
                ...
                <div class="card-body p-0 pt-0">
                    <div class="table-responsive">
                        <table class="table table-hover table-bordered align-middle mb-0" id="bankReceiptsTable" style="width:100%">
                            <thead>
                                <tr>
                                    <th width="50" class="ps-3 text-center">#</th>
                                    <th class="ps-3 text-center">Date</th>
                                    <th class="ps-3 text-center">Bank <small class="text-muted">(Debit)</small></th>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @permission('payments.bank-receiving.edit')
                                            <a href="{{ route('payments.bank-receiving.edit-vendor', $transaction->tid) }}" 
        ...
        <div class="modal-content border-0 shadow">
            <div class="modal-header bg-primary bg-opacity-10 border-0">
                <h5 class="modal-title" id="modalTitle">
                    <i class="bi bi-plus-circle me-2"></i>Add New Bank Receipt
                </h5>
            ...
            <div class="modal-body p-4" id="modalBody">
                <form id="bankReceiptForm" class="row g-3" action="{{ route('admin.payments.bank-receiving.store') }}" method="POST">
                    ...
                    <div class="col-md-6">
                        <label for="receive_date" class="form-label fw-medium">Receipt Date <span class="text-danger">*</span></label>
                        <div class="input-group mb-0">
                            <span class="input-group-text bg-light border-end-0">
                                <i class="bi bi-calendar"></i>
                            </span>
                            <input type="date" class="form-control border-start-0" id="receive_date" name="transaction_date" value="{{ $dateLock }}" disabled required>
                        </div>
                        <div class="invalid-feedback" id="receive_date-error"></div>
                    </div>

                    <div class="col-md-6">
                        <label for="select_banks" class="form-label fw-medium">Banks <small class="text-muted">(Debit)</small> <span class="text-danger">*</span></label>
                        <div class="input-group mb-0">
                            <span class="input-group-text bg-light border-end-0">
                    ...
                    <div class="col-md-6">
                        <label for="journal_vendor" class="form-label fw-medium">Select Account <small class="text-muted">(Credit)</small> <span class="text-danger">*</span></label>
                        <div class="input-group mb-0">
                            <span class="input-group-text bg-light border-end-0">
...
@push('scripts')
<script src="{{ asset('js/bank-receiving-ajax.js') }}"></script>
<script>
    $(document).ready(function() {
        $('#bankReceiptsTable').DataTable({
            processing: true,
            responsive: false,
            scrollX: true,
