                        ...
                        <table id="terminalsTable" class="table table-hover align-middle mb-0" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="ps-3 text-start">{{ $terminal->name }}</td>
                ...
                <form id="addTerminalForm" action="{{ route('admin.terminals.store') }}" method="POST" class="row g-3">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="input-group mb-0">
                            ...
                            <input type="text" class="form-control border-start-0" id="name" name="name" placeholder="Enter terminal name" required>
                        </div>
                ...
                <form id="editTerminalForm" action="{{ route('admin.terminals.update') }}" class="row g-3">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="input-group mb-0">
                            ...
                            <input type="text" class="form-control border-start-0" id="edit_name" name="name" placeholder="Enter terminal name" required>
                        </div>
