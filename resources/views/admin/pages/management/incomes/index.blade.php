        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white d-flex justify-content-between align-items-center py-3">
                    ...
                    @permission('management.incomes.create')
                ...
                <div class="card-body p-0 pt-0">
                    <div class="table-responsive">
                        <table class="table table-hover table-bordered align-middle mb-0" id="incomesTable" style="width:100%">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @permission('management.incomes.edit')
                                        ...
                                        @endpermission
                                        @permission('management.incomes.delete')
