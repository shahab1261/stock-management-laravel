                                ...
                                <div class="row">
                                    @php
                                        $permissionGroups = [
                                            ...
                                            'Sales' => ['sales.view', 'sales.create', 'sales.edit', 'sales.delete', 'sales.nozzle.view', 'sales.nozzle.create', 'sales.nozzle.edit', 'sales.nozzle.delete', 'sales.lubricant.view', 'sales.lubricant.create', 'sales.lubricant.delete', 'sales.credit.view', 'sales.credit.create', 'sales.credit.edit', 'sales.credit.delete'],
                                            ...
                                            'Payments' => ['payments.bank-receiving.view', 'payments.bank-receiving.create', 'payments.bank-receiving.edit', 'payments.bank-payments.view', 'payments.bank-payments.create', 'payments.bank-payments.edit', 'payments.cash-receiving.view', 'payments.cash-receiving.create', 'payments.cash-receiving.edit', 'payments.cash-payments.view', 'payments.cash-payments.create', 'payments.cash-payments.edit', 'payments.transaction.delete'],
                                            ...
                                            'History' => ['history.purchases.view', 'history.sales.view', 'history.credit-sales.view', 'history.bank-receivings.view', 'history.bank-payments.view', 'history.cash-receipts.view', 'history.cash-payments.view', 'history.journal-vouchers.view'],
