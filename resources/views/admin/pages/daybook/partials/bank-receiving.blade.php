<div class="d-flex justify-content-between align-items-center mb-4" style="border-bottom: 1px solid rgba(0, 0, 0, 0.125); padding-bottom: 10px;">
    <h5 class="mb-0"><i class="bi bi-bank2 me-2 text-primary"></i>Bank Receiving</h5>
    {{-- <button class="btn btn-sm btn-outline-primary print-section" data-section="bank-receiving-section">
        <i class="bi bi-printer me-1"></i>Print
    </button> --}}
</div>

<div id="bank-receiving-section" class="table-responsive">
