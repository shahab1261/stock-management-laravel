...
@section('title', 'Stock Management | Edit Product')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card p-4 shadow">
                <h3 class="mb-4 text-center product-title" style="font-size: 2.4rem; color: #4154f1;"><i class="bi bi-pencil-square"></i> Edit Product</h3>
                    ...
                    <div class="row g-4">
                            ...
                            <div class="card mb-4 border-0 shadow-sm">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('detail_name') is-invalid @enderror" id="detail_name" name="detail_name" value="{{ old('detail_name', $product->detail_name) }}" required>
                                        @error('detail_name')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control @error('index_no') is-invalid @enderror" id="index_no" name="index_no" value="{{ old('index_no', $product->index_no ?? 1) }}" min="1">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <small class="text-muted">Will auto-generate from name if left empty</small>
                                        @error('slug')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-check form-switch mb-3">
                                        <input class="form-check-input" type="checkbox" role="switch" id="discountToggle"
                                            name="discountToggle" value="1" {{ old('discountToggle', $product->discount_toggle) == 1 ? 'checked' : '' }}>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 mb-3">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" role="switch" id="status" name="status" value="1" {{ old('status', $product->status) ? 'checked' : '' }}>
                                                <label class="form-check-label" for="status">Active</label>
                                            </div>
                                        </div>
                                        <div class="col-md-4 mb-3">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" role="switch" id="featured" name="featured" value="1" {{ old('featured', $product->featured) ? 'checked' : '' }}>
                                                <label class="form-check-label" for="featured">Featured</label>
                                            </div>
                                        </div>
                                        <div class="col-md-4 mb-3">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" role="switch" id="isFree" name="is_free" value="1" {{ old('is_free', $product->is_free) ? 'checked' : '' }}>
                            ...
                            <div class="card mb-4 border-0 shadow-sm">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-3 text-center">
                                        ...
                                        <img id="currentImage" src="{{ asset($product->image) }}" alt="{{ $product->name }}" class="img-fluid rounded shadow-sm mb-3" style="max-height: 200px;">
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="card mb-4 border-0 shadow-sm">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            <textarea name="short_description" class="form-control @error('short_description') is-invalid @enderror" rows="5">{{ old('short_description', $product->short_description) }}</textarea>
                            ...
                            <div class="col-6">
                                <div class="card mb-4 border-0 shadow-sm">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            <textarea name="detail_description" class="form-control @error('detail_description') is-invalid @enderror" rows="5">{{ old('detail_description', $product->detail_description) }}</textarea>
                        ...
                        <div class="col-12">
                            <div class="card mb-4 border-0 shadow-sm">
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        <textarea id="my-editor" name="description" class="form-control @error('description') is-invalid @enderror">{{ old('description', $product->description) }}</textarea>
                                        @error('description')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                        ...
                        <div class="col-12">
                            <div class="card mb-4 border-0 shadow-sm">
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        <p class="text-muted mb-3">Manage audio files for this product</p>

                                        <!-- Existing Audio Files -->
                                        @if($product->playlists && $product->playlists->count() > 0)
                                        <div class="existing-audio-files mb-4">
                                            <h6 class="mb-3">Existing Audio Files</h6>
                                            <div class="row">
                                                @foreach($product->playlists as $playlist)
                                                <div class="col-md-12 mb-3">
                                                    <div class="existing-audio-item bg-light p-3 rounded position-relative" id="audio-item-{{ $playlist->id }}">
                                                        <button type="button" class="btn btn-sm btn-danger delete-audio position-absolute"
                                                                data-id="{{ $playlist->id }}" style="top: 10px; right: 10px;">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-2">
                                                                ...
                                                                <p class="mb-0">{{ $playlist->subtitle }}</p>
                                                            </div>
                                                            <div class="col-md-2">
                                                                <p class="fw-bold mb-1">Order No:</p>
                                                                <input type="number" class="form-control" name="existing_order_no[{{ $playlist->id }}]" value="{{ $playlist->order_no }}" min="0">
                                                            </div>
                                                            <div class="col-md-3">
                                                                <p class="fw-bold mb-1">Full Audio Name:</p>
                                                                <p class="mb-0">{{ Str::limit($playlist->full_name, 30) }}</p>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <p class="fw-bold mb-1">Audio:</p>
                                                                <audio controls class="w-100" style="max-width: 250px;">
                                                                    <source src="{{ route('audio.stream', ['product' => $product->id, 'file' => basename($playlist->file_path)]) }}" type="audio/mpeg">
                                        ...
                                        <!-- Hidden inputs for deleted audio files -->
                                        <div id="deleted-audio-container"></div>
                                        @endif

                                        <!-- Add New Audio Files -->
                                        <div class="new-audio-files">
                                            <h6 class="mb-3">Add New Audio Files</h6>
                                            <div id="audio-files-container">
                                                <!-- New audio files will be displayed here -->
                                            </div>
                        ...
                        <div class="col-12">
                            <div class="card mb-4 border-0 shadow-sm">
                                <div class="card-header custom-card-header">
                                    <h5 class="mb-0"><i class="bi bi-music-note-beamed me-2"></i>Zip Files</h5>
                                </div>
                                <div class="card-body">
                                    <div class="mb-3">
                                        <p class="text-muted mb-3">Manage zip files for this product</p>

                                        <!-- Existing Zip Files -->
                                        @if($product->products_download_zip && $product->products_download_zip->count() > 0)
                                        <div class="existing-zip-files mb-4">
                                            <h6 class="mb-3">Existing Zip Files</h6>
                                            <div class="row">
                                                @foreach($product->products_download_zip as $zip)
                                                    <div class="col-md-12 mb-3">
                                                        <div class="existing-zip-item bg-light p-3 rounded position-relative" id="zip-item-{{ $zip->id }}">
                                                            <button type="button" class="btn btn-sm btn-danger delete-zip position-absolute"
                                                                    data-id="{{ $zip->id }}" style="top: 10px; right: 10px;">
                                                                <i class="bi bi-x-circle"></i>
                                                            </button>
                                                            <div class="row">
                                                                <div class="col-md-2">
                                                                    <p class="fw-bold mb-1">Name:</p>
                                                                    <p class="mb-0">{{ $zip->name }}</p>
                                                                </div>
                                                                <div class="col-md-5">
                                                                    <p class="fw-bold mb-1">Zip:</p>
                                                                    <a href="{{ route('download.product.admin', [$product->id, $zip->id]) }}" class="btn btn-sm btn-primary" target="_blank">
                                                                        Download
                                                                    </a>
                                                                </div>
                                                            </div>
                                        ...
                                        <!-- Hidden inputs for deleted audio files -->
                                        <div id="deleted-zip-container"></div>
                                        @endif

                                        <!-- Add New Zip Files -->
                                        <div class="new-zip-files">
                                            <h6 class="mb-3">Add New Zip Files</h6>
                                            <div id="zip-files-container">
                                                <!-- New zip files will be displayed here -->
                                            </div>
                            ...
                            <div class="card mb-4 border-0 shadow-sm">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="meta_description" class="form-control @error('meta_description') is-invalid @enderror" rows="5">{{ old('meta_description', $product->meta_description) }}</textarea>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.delete-audio', function() {
                ...
                Swal.fire({
                    title: 'Are you sure?',
                    text: "This audio file will be removed from the product!",
                    icon: 'warning',
                    ...
                    if (result.isConfirmed) {
                        // Add a hidden input to track deleted audio IDs
                        $('#deleted-audio-container').append(`
                            <input type="hidden" name="deleted_audio_ids[]" value="${audioId}">
                        `);

                        // Hide the audio item from the UI
                        $(`#audio-item-${audioId}`).fadeOut(300, function() {
                            $(this).remove();
                        });
                    }
                });
                ...
                const zipFileHtml = `
                    <div class="zip-file-group bg-light p-3 rounded mb-3 position-relative" data-index="${index}">
                        ...
                        <div class="row">
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <label class="form-label">Zip File Name <span class="text-danger">*</span></label>
                        ...
                        <div class="zip-preview d-none mt-2">
                            <div class="d-flex align-items-center bg-white p-2 rounded">
                                <i class="bi bi-file-zip-fill text-primary me-2" style="font-size: 1.5rem;"></i>
                                <div class="flex-grow-1">
            ...
            $(document).on('click', '.delete-zip', function() {
                const zipId = $(this).data('id');

                Swal.fire({
                    title: 'Are you sure?',
                    text: "This zip file will be removed from the product!",
                    icon: 'warning',
                    showCancelButton: true,
                    confirmButtonColor: "#4154f1",
                    cancelButtonColor: "#151311",
                    ...
                    if (result.isConfirmed) {
                        // Add a hidden input to track deleted zip IDs
                        $('#deleted-zip-container').append(`
                            <input type="hidden" name="deleted_zip_ids[]" value="${zipId}">
                        `);

                        // Hide the audio item from the UI
                        $(`#zip-item-${zipId}`).fadeOut(300, function() {
                            $(this).remove();
                        });
                    }
                });
