            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white d-flex justify-content-between align-items-center py-3">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <button type="button" id="openNozzleSalesModalBtn" class="btn btn-primary d-flex align-items-center">
                ...
                <div class="card-body p-0 pt-0">
                    <div class="table-responsive">
                        <table id="salesTable" class="table table-hover align-middle mb-0 text-center" style="width:100%">
                            ...
                            <tbody>
                                @foreach($sales as $sale)
                                    @php
                                        ...
                                        $nozzle = $sale->nozzle_id ? \App\Models\Management\Nozzle::find($sale->nozzle_id) : null;
    ...
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content border-0 shadow">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title" id="nozzleSalesModalLabel"><i class="bi bi-fuel-pump me-2"></i>Add Nozzle Sales</h5>
                    ...
                    <div class="row mb-3 gx-2">
                        <div class="col-12 col-md-3">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control border-start-0" id="sale_date" type="date" value="{{ $dateLock }}" disabled required max="{{ date('Y-m-d') }}">
                            </div>
                        </div>
...
@push('scripts')
<script src="{{ asset('js/nozzle-sales-ajax.js') }}"></script>
@endpush
