            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white d-flex justify-content-between align-items-center py-3">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <button type="button" id="openLubricantSalesModalBtn" class="btn btn-primary d-flex align-items-center">
                ...
                <div class="card-body p-0 pt-0">
                    <div class="table-responsive">
                        <table id="lubricantSalesTable" class="table table-hover align-middle mb-0 text-center" style="width:100%">
                            ...
                            <tbody>
                                @foreach($sales as $sale)
                                    ...
                                    <tr>
                                        ...
                                        <td class="ps-3 text-center">{{ date('d-m-Y', strtotime($sale->create_date)) }}</td>
                                        ...
                                        {{-- <td class="ps-3 text-center"> --}}
                                            {{-- @php $canDelete = (isset($lastSaleIds[$sale->product_id]) && $lastSaleIds[$sale->product_id] == $sale->id) && (auth()->user()->user_type == 1); @endphp --}}
...
<div class="modal fade" id="lubricantSalesModal" tabindex="-1" aria-labelledby="lubricantSalesModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content border-0 shadow">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title" id="lubricantSalesModalLabel"><i class="bi bi-droplet me-2"></i>Add Lubricant Sales</h5>
            ...
            <div class="modal-body" style="max-height:70vh; overflow-y:auto;">
                <form id="lubricant_sales_form">
                    <div class="row mb-3 gx-2">
                        <div class="col-12 col-md-3">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control border-start-0" id="lubricant_sale_date" type="date" value="{{ $dateLock }}" required max="{{ date('Y-m-d') }}" disabled>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3 gx-2">
                        ...
                        <div class="col-12 col-md-2 d-flex align-items-center"><p class="mb-0 pt-3" id="lubricant_quantity_total"></p></div>
                        <div class="col-12 col-md-2"></div>
                        <div class="col-12 col-md-2 d-flex align-items-center"><p class="mb-0 pt-3" id="lubricant_amount_total"></p></div>
                    </div>
                    ...
                    <div class="row gx-2 align-items-end">
                        ...
                        <div class="col-12 col-md-3 ms-auto d-grid">
                            <button type="submit" id="lubricant_add_sales_btn" class="btn btn-primary">Submit</button>
                        </div>
                    </div>
                </form>
            </div>
...
<style>
    ...
    .dataTables_wrapper .dataTables_paginate { color: #6c757d; padding: 8px; }
    .dataTables_wrapper .dataTables_length { padding-left: 15px; }
...
<script>
    ...
    window.lubricantProducts = [
        @foreach($products as $p)
            { id: {{ $p->id }}, name: "{{ $p->name }}", opening: {{ (float)($stockByProduct[$p->id] ?? 0) }}, rate: {{ (float)$p->current_sale }}, tank_id: {{ (int)($p->tank_id ?? 0) }} },
        @endforeach
    ];
</script>
