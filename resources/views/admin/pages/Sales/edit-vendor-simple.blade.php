...
@section('title', 'Edit Sale Vendor')
@section('description', 'Update vendor account for this sale')
...
<div class="container-fluid py-4">
    <div class="row mb-4">
        <div class="col-12 text-center">
            ...
            <p class="text-muted mb-0">Update only the vendor account for this sale</p>
        </div>
    </div>

    <form id="editVendorForm" action="{{ route('sales.update-vendor', $sale->id) }}" method="POST">
        @csrf
