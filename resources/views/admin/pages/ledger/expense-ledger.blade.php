...
@section('description', 'Expense Ledger and Transaction Details')
...
<div class="container-fluid py-4">
    ...
    <div class="row mb-4">
        <div class="col-12 text-center">
            <h3 class="mb-0"><i class="bi bi-wallet2 text-primary me-2"></i>Expense Ledger</h3>
            <p class="text-muted mb-0">Expense ledger records from {{ date('d-m-Y', strtotime($startDate)) }} to {{ date('d-m-Y', strtotime($endDate)) }}</p>
        </div>
    </div>
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.ledger.expense') }}" method="get" class="row align-items-end">
                        <div class="mb-3" style="width: 202px;">
                            <label for="expense_id" class="form-label">Expense</label>
                            <select class="form-select searchable-dropdown" id="expense_id" name="expense_id">
                                <option selected disabled>All Expenses</option>
                                @foreach($expenses as $expense)
                                    <option value="{{ $expense->id }}" {{ $expenseId == $expense->id ? 'selected' : '' }}>
                        ...
                        <div class="col-md-2 mb-3">
                            <a href="{{ route('admin.ledger.expense') }}" class="btn btn-secondary w-100">
        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white d-flex justify-content-between align-items-center py-3">
                    <h5 class="mb-0"><i class="bi bi-wallet2 me-2"></i>Expense Ledger Details</h5>
...
@push('scripts')
<script src="{{ asset('js/ledger.js') }}?v=1.3"></script>
@endpush
