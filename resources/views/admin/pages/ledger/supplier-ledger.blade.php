...
@section('description', 'Supplier Ledger and Transaction Details')
...
<div class="container-fluid py-4">
    ...
    <div class="row mb-4">
        <div class="col-12 text-center">
            <h3 class="mb-0"><i class="bi bi-truck text-primary me-2"></i>Supplier Ledger</h3>
            <p class="text-muted mb-0">Supplier ledger records from {{ date('d-m-Y', strtotime($startDate)) }} to {{ date('d-m-Y', strtotime($endDate)) }}</p>
        </div>
    </div>
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.ledger.supplier') }}" method="get" class="row align-items-end">
                        <div class="mb-3" style="width: 202px;">
                            <label for="supplier_id" class="form-label">Supplier</label>
                            <select class="form-select searchable-dropdown" id="supplier_id" name="supplier_id">
                                <option disabled selected>All Suppliers</option>
                        ...
                        <div class="col-md-2 mb-3">
                            <a href="{{ route('admin.ledger.supplier') }}" class="btn btn-secondary w-100">
        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white d-flex justify-content-between align-items-center py-3">
                    <h5 class="mb-0"><i class="bi bi-truck me-2"></i>Supplier Ledger Details</h5>
