...
@section('title', 'MP Ledger')
@section('description', 'MP Ledger and Transaction Details')
...
<div class="container-fluid py-4">
    ...
    <div class="row mb-4">
        <div class="col-12 text-center">
            <h3 class="mb-0"><i class="bi bi-joystick text-primary me-2"></i>MP Ledger</h3>
            <p class="text-muted mb-0">MP ledger records from {{ date('d-m-Y', strtotime($startDate)) }} to {{ date('d-m-Y', strtotime($endDate)) }}</p>
        </div>
    </div>
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.ledger.mp') }}" method="get" class="row align-items-end justify-content-center">
                        ...
                        <div class="col-md-2 mb-3">
                            <a href="{{ route('admin.ledger.mp') }}" class="btn btn-secondary w-100">
        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white d-flex justify-content-between align-items-center py-3">
                    <h5 class="mb-0"><i class="bi bi-joystick me-2"></i>MP Ledger Details</h5>
