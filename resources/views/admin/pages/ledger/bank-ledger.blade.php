...
@section('description', 'Bank Ledger and Transaction Details')
...
<div class="container-fluid py-4">
    ...
    <div class="row mb-4">
        <div class="col-12 text-center">
            <h3 class="mb-0"><i class="bi bi-bank2 text-primary me-2"></i>Bank Ledger</h3>
            <p class="text-muted mb-0">Bank ledger records from {{ date('d-m-Y', strtotime($startDate)) }} to {{ date('d-m-Y', strtotime($endDate)) }}</p>
        </div>
    </div>
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.ledger.bank') }}" method="get" class="row align-items-end">
                        <div class="mb-3" style="width: 202px;">
                            <label for="bank_id" class="form-label">Bank</label>
                            <select class="form-select searchable-dropdown" id="bank_id" name="bank_id">
                                <option selected disabled>All Banks</option>
                        ...
                        <div class="col-md-2 mb-3">
                            <a href="{{ route('admin.ledger.bank') }}" class="btn btn-secondary w-100">
