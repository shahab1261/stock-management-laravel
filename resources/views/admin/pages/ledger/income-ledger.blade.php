...
@section('description', 'Income Ledger and Transaction Details')
...
<div class="container-fluid py-4">
    ...
    <div class="row mb-4">
        <div class="col-12 text-center">
            <h3 class="mb-0"><i class="bi bi-graph-up-arrow text-primary me-2"></i>Income Ledger</h3>
            <p class="text-muted mb-0">Income ledger records from {{ date('d-m-Y', strtotime($startDate)) }} to {{ date('d-m-Y', strtotime($endDate)) }}</p>
        </div>
    </div>
            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.ledger.income') }}" method="get" class="row align-items-end">
                        ...
                        <div class="col-md-2 mb-3">
                            <a href="{{ route('admin.ledger.income') }}" class="btn btn-secondary w-100">
        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white d-flex justify-content-between align-items-center py-3">
                    <h5 class="mb-0"><i class="bi bi-graph-up-arrow me-2"></i>Income Ledger Details</h5>
