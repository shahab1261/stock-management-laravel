            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body p-0 pt-0">
                    <div class="table-responsive">
                        <table class="table table-hover table-bordered table-bordered align-middle mb-0" id="profitTable" style="width:100%">
                            <thead>
                                <tr>
...
@push('scripts')
<script src="{{ asset('js/profit.js') }}?v=1.3"></script>
<script>
