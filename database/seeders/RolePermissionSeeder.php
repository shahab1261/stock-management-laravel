...
class RolePermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $permissions = [
            ...
            'management.customer-vehicles.create',
            'management.customer-vehicles.edit',
            'management.customer-vehicles.delete',
        ...
        $adminPermissions = [
            ...
            'sales.nozzle.view', 'sales.nozzle.create', 'sales.nozzle.edit', 'sales.nozzle.delete',
            ...
            'payments.bank-receiving.view', 'payments.bank-receiving.create', 'payments.bank-receiving.edit',
            'payments.bank-payments.view', 'payments.bank-payments.create', 'payments.bank-payments.edit',
            'payments.cash-receiving.view', 'payments.cash-receiving.create', 'payments.cash-receiving.edit',
            'payments.cash-payments.view', 'payments.cash-payments.create', 'payments.cash-payments.edit',
            ...
            'management.customer-vehicles.view', 'management.customer-vehicles.create', 'management.customer-vehicles.edit',
