...
(function () {
  ...
  function mobileNavToogle() {
    ...
    if (mobileNavToggleBtn && mobileNavToggleBtn.classList.contains('bi-x')) {
      mobileNavToggleBtn.style.marginTop = '50px';
      mobileNavToggleBtn.style.zIndex = '9999990';
      mobileNavToggleBtn.style.color = '#4154f1';
      mobileNavToggleBtn.style.position = 'relative';
    } else if (mobileNavToggleBtn) {
      mobileNavToggleBtn.style.marginTop = '6px';
      mobileNavToggleBtn.style.zIndex = '';
      mobileNavToggleBtn.style.color = '';
      mobileNavToggleBtn.style.position = '';
    }
  }
