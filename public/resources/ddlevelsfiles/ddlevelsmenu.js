...
var ddlevelsmenu = {
  ...
  arrowpointers: {
    downarrow: ['/resources/ddlevelsfiles/arrow-down.gif', 11, 7], //[path_to_down_arrow, arrowwidth, arrowheight]
    rightarrow: ['/resources/ddlevelsfiles/arrow-right.gif', 12, 12], //[path_to_right_arrow, arrowwidth, arrowheight]
  ...
  buildmenu: function (mainmenuid, header, submenu, submenupos, istoplevel, dir) {
        ...
        if (ddlevelsmenu.ismobile || !ddlevelsmenu.isContained(this, e)) {
          ...
          if (!ddlevelsmenu.ismobile) {
            ...
            if (header._istoplevel || e.target.parentNode.getElementsByTagName('ul').length > 0) {
              //if user clicks on a header (instead of a menu item)
              e.preventDefault();
              e.stopPropagation();
            }
          }
    ...
    this.addEvent(
      ...
      function (e) {
        ...
        var submenu = ddlevelsmenu.subuls[this._master][parseInt(this._pos)];
        if (this._istoplevel) {
          if (!ddlevelsmenu.isContained(this, e) && !ddlevelsmenu.isContained(submenu.parentNode, e))
            //hide drop down div if mouse moves out of menu bar item but not into drop down div itself
    ...
    if (elapsed < this.effects.duration) {
      if (this.effects.enableswipe) {
        if (submenu._curanimatedegree == 0) {
          ...
          submenu.parentNode.style[header._istoplevel && dir == 'topbar' ? 'width' : 'height'] =
            (header._istoplevel && dir == 'topbar' ? submenu.offsetWidth : submenu.offsetHeight) + 'px';
        }
  ...
  hidemenu: function (submenu) {
    if (typeof submenu._pos != 'undefined') {
      //if submenu is outermost DIV drop down menu
    ...
    for (var i = 0; i < alllinks.length; i++) {
      if (alllinks[i].getAttribute('rel')) {
        ...
        this.addEvent(
          shelldiv,
          function (e) {
            //hide menu if mouse moves out of main DIV element into open space
