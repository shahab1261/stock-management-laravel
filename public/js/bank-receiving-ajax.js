$(document).ready(function() {
    ...
    $('#addNewReceiptBtn').click(function() {
    ...
    // Bank Receipt Form Submission
    $("#bankReceiptForm").submit(function(e) {
        e.preventDefault();
        ...
        var transactionDate = $("#receive_date").val();
        ...
        var bankValue = $("#select_banks").val();
        var bankId = $("#select_banks").find('option:selected');
        var bankName = bankId.data('bankid');

        // AJAX request
        $.ajax({
            url: $("#bankReceiptForm").attr('action'),
            type: "POST",
            data: {
